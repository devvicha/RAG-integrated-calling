...
export const KNOWLEDGE_BASE_JSON = [
      ...
      "intents": [
        {
          "name": "OpenAccount",
          "slots": [
            { "name": "account_type", "entity": "AccountType", "required": true },
            { "name": "channel", "entity": "Channel", "required": false }
          ],
          ...
          "policy_links": ["accounts.opening_workflow"]
        },
        {
          "name": "LoanInquiry",
          "slots": [
            { "name": "loan_type", "entity": "LoanType", "required": true },
            { "name": "amount", "entity": "sys.number", "required": false },
            { "name": "tenure_months", "entity": "sys.number", "required": false }
          ],
        ...
        },
        {
          ...
          "policy_links": ["workflows.card_lost_block"]
        },
        {
          "name": "TransferHelp",
          "slots": [
        ...
        },
        {
          "name": "Complaint",
          "slots": [
            { "name": "category", "entity": "sys.any", "required": true },
            { "name": "summary", "entity": "sys.any", "required": true }
          ],
  ...
  },
  {
    ...
    "pii": false,
    "type": "markdown",
    "content": "- **Sampath e‑Remittance** — Instant web‑based money transfer receipts for customers and non‑customers.\n- **SWIFT** — International wire transfers; FX conversion at bank rates."
  },
  {
